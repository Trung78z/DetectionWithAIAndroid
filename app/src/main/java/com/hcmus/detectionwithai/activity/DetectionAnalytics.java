...
public class DetectionAnalytics extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detect_analytics);
        ...
        analyticsButton = findViewById(R.id.analyticsImageButton);
    ...
    private void onAnalytics() {
        ...
        // Perform analysis
        geminiAnalyzer.analyzeImage(bitmapImage, selectedLanguageCode, new AnalysisCallback() {
            @Override
            ...
            public void onFailure(Throwable t) {
                runOnUiThread(() -> {
                    showLoading(false);
                    analyticsButton.setEnabled(true);
                    resultDisplay.showResult(t.getMessage());
                    Toast.makeText(DetectionAnalytics.this, "Analysis failed", Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
